                    ...
                    <div className="col-12 col-lg-10">
                      <div className="case-d-content-right sticky-item">
                        ...
                        <div className="text-group">
                          ...
                          <p>
                          At Web Learn Hub, we believe in learning by doing. Our program is built to offer immersive experiences that 
                          go beyond theory, allowing you to:
                          </p>
                          <ul>
                          ...
                          <p>
                          Our web development internship is designed to give you more than just theoretical knowledge. It offers a hands-on, 
                          immersive learning experience that prepares you for real-world challenges in the web development industry. You will 
                          work on live projects, gain practical coding skills, and collaborate with experienced professionals. Our program 
                          focuses on empowering you with the latest technologies and best practices, ensuring you are well-equipped to excel 
                          in today &apos; s competitive job market. Whether you are looking to build your portfolio or master full-stack 
                        ...
                        <div className="text-group">
                          <div className="quote-group">
                            ...
                            <div className="content">
                              ...
                              <p className="tertiary-text">Paul Cookson</p>
                            </div>
                          </div>
                          <p>
                          ...
                          strong portfolio, a deep understanding of the web development process, and the skills employers are looking for in 
                ...
                <div className="mt-5 py-1 feature fade-wrapper fade-top">
                        ...
                        <div className="row gaper">
                                ...
                                <div className="section__header text-start my-5">
                                      ...
                                      <p>This internship is ideal for students, recent graduates, or anyone looking to transition into 
                                        a career in web development. Whether you have a background in programming or are new to the field, 
                                        our program is designed to support learners at various levels.</p>
                                </div>
                                <div className="section__header text-start my-5">
                                      <h2 className="title title-animation mt-12">How to Apply</h2>
                                      <p>Ready to kick-start your web development journey? Apply now by submitting your resume and portfolio, 
                                        or reach out to us with any questions. We look forward to helping you grow your skills and advance your 
...
export default LearnWebContent;
