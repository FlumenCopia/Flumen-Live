          ...
          <div className="col-12">
            <div className="text-brief__inner">
              <div className="t-br-one">
                ...
                <h2 className="light-title fw-7 text-black title-animation">
                  {" "}
              ...
              <div className="t-br-two">
                <h3 className="light-title fw-7 text-black title-animation">
                to Expertise Across
                </h3>
              ...
              <div className="t-br-three">
                ...
                <h4 className="light-title fw-7 text-black title-animation">
                 Endless Diverse Fields
                </h4>
              </div>
            </div>
          </div>
