...
import Thumb from "@/public/images/about_faq.jpg";
      ...
      <div className="container">
        <div className="row gaper align-items-center">
          <div className="col-12 col-lg-6">
            <div className="h-empower__thumb reveal-img parallax-img display-none2">
                  ...
                  return (
                    ...
                    >
                      <div className="lefter">
                        <h4 style={{fontWeight:'bold'}}>{item.question}</h4>
                        <AnimateHeight
                          duration={300}
