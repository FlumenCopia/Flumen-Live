...
import poster from "@/public/images/services/social-poster.png";
import one from "@/public/images/services/social-one.png";
            ...
            <div className="s-details__sidebar sticky-item">
              ...
              <div className="s-details-contact slide-top">
                ...
                <ul className="section__content-cta">
                  <li>
                    <a href="mailto:contact.vertio@gmail.com">
                      <span className="material-symbols-outlined">mail</span>
                      contact.vertio@gmail.com
                    </a>
                  </li>
                  <li>
                    <a href="tel:1-658-361-253">
